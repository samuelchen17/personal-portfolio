...
const About = () => {
  return (
    <div className="bg-blue-400 h-dvh">
      <h1>ABOUT</h1>
      <div>
        I am a driven and enthusiastic aspiring software engineer with a strong
        foundation in civil engineering, which has honed my problem-solving
        abilities and keen attention to detail. My passion for software
